...
public class ExcelHelpers {
    ...
    public static List<Integer> findRow(XSSFSheet sheet, String cellContent) {
...
//                        System.out.println(cell.getAddress().toString());
                        result.add(cell.getRow().getRowNum());
                    }
                }
            }
        }
    ...
    public static String output(XSSFSheet sheet, int rownr, int colnr) {
        try {
